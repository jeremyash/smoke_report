...
This report documents the recent air quality, weather forecast and smoke analysis for the `r fire_info$name` prescribed fire, planned for `r params$FIRE_DATE`. For more information:  `r ifelse(params$AUTHOR == "Trent Wickman", "https://inciweb.nwcg.gov/", paste(params$AUTHOR, "Air Resource Specialist", air_spec_contact$number,  air_spec_contact$email, sep = ", "))`. 
...
**Note**: Generally, smoke sensitive people are kids and older adults along with those who have cardiovascular or respiratory conditions. These groups should take appropriate precautions. See your health professional as needed. 

Smoke and Health Information: [https://airnow.gov/](https://airnow.gov/)

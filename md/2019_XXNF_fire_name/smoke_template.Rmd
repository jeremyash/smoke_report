...
This report documents the recent air quality, weather forecast and smoke analysis for the `r fire_info$name` fire, planned for `r params$FIRE_DATE`. For more information, please contact `r params$AUTHOR`, Air Resource Specialist, `r air_spec_contact$number`, `r air_spec_contact$email`. 

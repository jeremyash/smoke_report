---
title: "Smoke Outlook for `r params$FIRE_NAME` Fire"
...
This report documents the recent air quality, weather forecast and smoke analysis for the `r fire_info$name` prescribed fire, planned for `r params$FIRE_DATE`. For more information, please contact `r params$AUTHOR`, Air Resource Specialist, `r air_spec_contact$number`, `r air_spec_contact$email`. 

## Recent Air Quality in Area 

Shown below is the recently measured air quality index (AQI, [https://airnow.gov/](https://airnow.gov/)) in the area. The map shows the location of the fire and the most recent daily AQI. The figure shows the daily AQI for the previous 3 days.
...
include_graphics(c(paste(file_path, "day_one_ave.jpg", sep = ""),
                   paste(file_path, "day_one_max.jpg", sep = "")))

```

__Smoke conditions on day two of the modeling run: 24 average (top) and maximum (bottom)__
```{r bluesky_maps_day_two, echo = FALSE, out.width="70%", out.height="50%",fig.show='hold',fig.align='center'}
...
include_graphics(c(paste(file_path, "day_two_ave.jpg", sep = ""),
                   paste(file_path, "day_two_max.jpg", sep = "")))
...
include_graphics("md_data/met_data.PNG")

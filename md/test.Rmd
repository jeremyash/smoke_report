...
```{r fire_map_aqi, include = TRUE, echo = FALSE, message = FALSE,  fig.width=8, fig.height=3}


# # Monitor Map showing Max HOurly AQI
# monitor_esriMap(airnow, 
#                 centerLon = fire_info$lon, 
#                 centerLat = fire_info$lat,
#                 zoom = 8,
#                 width = 600, 
#                 height = 600, 
#                 cex = 2)
# addIcon('redFlame', fire_info$lon, fire_info$lat, expansion = .0008)
# text(fire_info$lon, fire_info$lat, fire_info$name, pos = 3, cex = .8, col = "firebrick4")
...
# ggarrange(fire_map, daily_aqi_plot, 
#              widths = c(8,2))

# knitr::include_graphics("../figures/aqi_table.PNG")

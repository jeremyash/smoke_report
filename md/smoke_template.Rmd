---
title: paste("Smoke Outlook for ", "`r params$FIRE_NAME`", sep = "")
...
This report documents the recent air quality, weather forecast and smoke analysis for the `r fire_info$name` fire. For more information, please contact `r params$AUTHOR`, Air Resource Specialist, `r air_spec_contact$number`, `r air_spec_contact$email`. 
...
day_two_avg <- tibble(x = fire_info$lon,
                        y = fire_info$lat,
                        image = "../figures/test_bsky_img.png")
...
fire_map <- ggmap(fire_map_info, extent = "device") +
  ...
  geom_image(aes(x = x, y = y, image = image), data = day_two_avg) +
